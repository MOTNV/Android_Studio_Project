...
public class LlmAnalyzer {
    ...
    public AnalysisResult analyze(String text) {
        ...
        List<String> academic = Arrays.asList("성적", "grade", "출석", "시험", "평가");
        List<String> assignment = Arrays.asList("과제", "프로젝트", "실습");
        List<String> counseling = Arrays.asList("상담", "우울", "개인", "고민", "stress", "스트레스");
        List<String> emergency = Arrays.asList("위협", "위험", "신고", "긴급", "help");
        List<String> admin = Arrays.asList("등록금", "휴학", "복학", "장학", "행정");
        List<String> blockchain = Arrays.asList("블록체인", "blockchain", "코인", "암호화폐");
        List<String> iot = Arrays.asList("iot", "사물인터넷", "센서");
        List<String> nlp = Arrays.asList("nlp", "자연어처리", "텍스트");
