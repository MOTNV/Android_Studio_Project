...
public class RecipientDirectory {
    ...
    public RecipientDirectory() {
        recipients.add(new Recipient("professor", "담당 교수", "학업 지도", Arrays.asList("성적", "시험", "출석", "평가")));
        recipients.add(new Recipient("ta", "과목 조교", "조교", Arrays.asList("과제", "프로젝트", "실습")));
        recipients.add(new Recipient("counsel", "학생 상담센터", "상담 지원", Arrays.asList("상담", "우울", "개인", "고민", "스트레스")));
        recipients.add(new Recipient("admin", "학과조교", "행정 담당", Arrays.asList("행정", "등록금", "휴학", "복학", "신청")));
        recipients.add(new Recipient("safety", "신고 담당", "신고/보안", Arrays.asList("위협", "폭력", "신고", "긴급", "위험")));
    }
