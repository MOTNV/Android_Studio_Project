...
/**
 * Static seed data for professors. Keep in sync with FastAPI professor DB.
 */
public class ProfessorDirectory {
    ...
    private static final List<Professor> PROFESSORS = Collections.unmodifiableList(Arrays.asList(
            ...
            new Professor(
                    ...
                    "Jangwon Gim",
                    "교수",
                    Arrays.asList("실시간 빅데이터", "자연어처리", "지식그래프", "데이터 거버넌스", "real-time big data", "nlp", "knowledge graph"),
            ...
            new Professor(
                    ...
                    "Hyunjun Jung",
                    "교수",
                    Arrays.asList("IoT", "블록체인", "네트워크 보안"),
            ...
            new Professor(
                    ...
                    "Neunghoe Kim",
                    "교수",
                    Arrays.asList("소프트웨어공학", "오피니언 마이닝", "빅데이터", "software engineering"),
            ...
            new Professor(
                    ...
                    "Youngju Nam",
                    "교수",
                    Arrays.asList("차량 네트워크", "IoT", "인공지능", "최적화", "ai"),
            ...
            new Professor(
                    ...
                    "Jun Ma",
                    "교수",
                    Arrays.asList("그래픽스", "디지털트윈", "게임", "AR/VR", "의료 AI", "graphics", "digital twin", "ar", "vr", "medical ai"),
            ...
            new Professor(
                    ...
                    "조교",
                    Arrays.asList("수강신청", "성적문의", "휴학", "복학", "장학금", "일반행정", "학사일정"),
                    "학과사무실",
                    "office@kunsan.ac.kr",
                    "",
                    "학과사무실"
